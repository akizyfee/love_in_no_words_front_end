...
<template>
  ...
  <div class="flex justify-end my-6">
    <button @click="handleModalOpen(true)" class="btn btn-dark whitespace-nowrap">新增優惠</button>
  </div>
  <!-- table -->
  <section class="relative overflow-x-auto bg-bgself-light rounded-xl p-6">
    <table class="w-full text-center">
      ...
      <tbody>
        <tr class="border-b-2 border-black">
          <td class="text-center">馬卡龍</td>
          <td class="text-center">買一送一</td>
          <th class="text-center">2023/05/01</th>
